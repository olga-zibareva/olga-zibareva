...
|--------------------|--------------------------------------------------|--------------------------|
|neural_networks|Учебные задачи поэтапного конструирования нейронных сетей: создание полносвязных слоёв, создание свёрточных слоёв, использование алгоритма `Adam`, использование архитектуры `ResNet`|`numpy`, `keras`, `tensorflow`|
