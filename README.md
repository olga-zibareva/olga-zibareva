...
|--------------------|--------------------------------------------------|--------------------------|
|[telecom](https://github.com/olga-zibareva/telecom)|Построение модели для предсказания оттока клиентов телекоммуникационной компании в целях снижения оттока. Обучение нескольких моделей для решения задачи классификации. Выбор лучшей модели|`pandas`, `numpy`, `matplotlib`, `seaborn`, `sklearn`, `phik`, `catboost`, `patsy`, `statsmodels`|
|[computer_vision](https://github.com/olga-zibareva/computer_vision)|Обработка изображений. Построение модели, которая по фотографии определит приблизительный возраст человека. Решение задачи регрессии с использованием нейронной сети|`pandas`, `numpy`, `keras`, `tensorflow`, `matplotlib`|
